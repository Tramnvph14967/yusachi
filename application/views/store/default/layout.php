...
<body style="font-family: <?= $cart_store_side_font['cart_store_side_font'] ?> !important;">
  ...
  ?>
    ...
    <div class="top-bar bg-main text-white text-center" style="background:#2a2a2a">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div class="header-right-listing">
            <ul class="d-flex">
              ...
              <?php if ($is_logged) { ?>
                <div class="dropdown">
                  ...
                  <ul class="js-dropdown-list2">
                    ...
                    <li class="d-flex"><a class="text-dark" href="<?= base_url('usercontrol/dashboard'); ?>"><i class="fa fa-solid fa-chart-line"></i> &nbsp;&nbsp;<?= __('Bảng điều khiển') ?></a></li>
              ...
              <?php } else { ?>
                <li><a href="login" class="top-login-btn btn bg-main2 text-white d-flex align-items-center"><img alt="<?= __('store.image') ?>" src="<?= base_url('assets/store/default/'); ?>img/signin.png" class="mr-2" /><?= __('store.login') ?></a></li>
              <?php } ?>

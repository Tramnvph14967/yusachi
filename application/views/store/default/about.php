<style>
	...
	.achievement .content .title-content h1{
		font-size: 55px;
		color: #000;
	}
	...
	.achievement .content .content-achievement .section-content{
		display: flex;
		flex-direction: column;
		gap: 10px;
		justify-content:center;
	...
	.achievement .content .content-achievement .section-content h2
{font-size: 45px;}

	.achievement .content .content-achievement .section-content h2,
	.achievement .content .content-achievement .section-content h4{
		color: #000;
	}
	...
	<div class="container">
		...
		<div class="row about1">
			...
			<div class="col-12 col-md-12 col-lg-8 col-xl-6 pt-4">
				<div class="about-top-text">
					<p class="sub-title">EFFECTIVE FOR SKIN</p>
		...
		<div class="row about1" style="background-color:#FAF3EB">
			<div class="title-about">
				<h6>Giải Pháp Chăm Sóc</h6>
				<div class="line"></div>
				<h2>Kết Quả Chăm Sóc Cơ Thể</h2>
			...
			<div class="content-left col-12 col-md-12 col-lg-4 col-xl-6">
				<div class="content">
					...
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras vel mi quam. Fusce vehicula vitae mauris sit amet tempor donec consectetur.</p>
		...
		<div class="row about1">
			<div class="image-slider1">
				<div class="slider-items">
					<div class="image">
						<img src="https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcTsTiddQhzosr1S1M8KE8BeAxU6uZDMkfYWbSXIjir5rKGDmaYH" alt="">
					</div>
				</div>
				<div class="slider-items">
					<div class="image">
						<img src="https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcTowWOqjOjwgk7ZAbT9L4d6bGs_z5GbSxuSRuaQt_V5YysbaNsh" alt="">
					</div>
				</div>
				<div class="slider-items">
					<div class="image">
				...
				<div class="slider-items">
					<div class="image">
						<img src="https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcRAW22UDkAzX-SuN-VZF4Ymj7Pa-dUsXp--0HY4ydVUOFBnGG4V" alt="">
					</div>
				</div>
				<div class="slider-items">
					<div class="image">
						<img src="https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcSBUzeEUBPRx9Ageocqb_w1pzKGhahRuu3l_1V2Wd-JmQHXcXys" alt="">
					</div>
				</div>
				<div class="slider-items">
					<div class="image">
			...
			<div class="achievement">
				...
				<div class="content">
					<div class="title-content">
						<h6>THỊ TRƯỜNG MỸ PHẨM</h6>
						<h1>TỐT NHẤT TẠI VIỆT NAM</h1>
					</div>
